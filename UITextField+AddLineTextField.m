...
-(void)addLine{
    UIImageView *imageline =[[UIImageView alloc] initWithFrame:CGRectMake(0,
                                                                          ...
                                                                          Macro_AutoWidth_7p(1))];
    [imageline setBackgroundColor:MacroDV_ThemeColor_red];
    imageline.layer.cornerRadius =Macro_AutoWidth_7p(0.5);
    [self addSubview:imageline];
    self.tintColor= MacroDV_ThemeColor_red;
...
-(void)addVerificationCode{
    ...
    [verificationCodeBtn setTitleColor:MacroDV_ThemeColor_red forState:UIControlStateNormal];
    ...
    verificationCodeBtn.layer.borderColor = MacroDV_ThemeColor_red.CGColor;
